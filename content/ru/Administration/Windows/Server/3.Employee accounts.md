...
Import-Csv "C:\Temp\users.csv" | ForEach-Object {
    ...
    New-ADUser `
        ...
        -Path "OU=IT-Dept,DC=corp,DC=vitaliy,DC=local" ` # <-- ПОМЕНЯЙ путь к OU
        -AccountPassword $DefaultPassword `
        -Enabled $true `
        -ChangePasswordAtLogon $true `  # <-- ВОТ ОНО! Магия принудительной смены
        -Department $_.Department

    Write-Host "Пользователь $FullName создан." -ForegroundColor Green
}
```

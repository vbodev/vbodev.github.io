...
[[singleton.jpeg]]
![[singleton.jpeg]]
###### **🧭Purpose:** Ensures that the system has **only one instance of a class** and provides a global access point to it.
...
[[factory_method.jpeg]]
![[factory_method.jpeg]]
###### **🧭Purpose:** Delegates object creation to subclasses without specifying the exact type.
...
[[abstractfactory.jpg]]
![[abstractfactory.jpg]]
###### **🧭Purpose:** Provides an **interface for creating objects**, where each specific subclass decides _which exact_ implementations to use.
